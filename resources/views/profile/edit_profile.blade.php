<div id="EditProfileModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form method="POST" id="editProfileForm" enctype="multipart/form-data" action="{{ route('usuarios.update',$user->id) }}" >                
                <div class="modal-body">
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary" id="btnPrEditSave" tabindex="5">
                            Grabar
                        </button>
                        <button type="button" class="btn btn-light ml-1 edit-cancel-margin margin-left-5" data-dismiss="modal">
                            Cancelar
                        </button>
                    </div>
                </div>
